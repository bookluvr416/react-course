...
function App() {
  ...
  const [errorLoadingPlaces, setErrorLoadingPlaces] = useState();
  ...
  useEffect(() => {
    async function fetchPlaces() {
      ...
      try {
        ...
        setErrorLoadingPlaces({ message: err.message || 'Error loading user places.' });
      }
      setIsLoading(false);
    }
    ...
    <>
      ...
      <main>
        {errorLoadingPlaces && (
          <Error
            title="Error occured"
            message={errorLoadingPlaces.message}
            onConfirm={handleError}
          />
        )}
        {!errorLoadingPlaces && (
