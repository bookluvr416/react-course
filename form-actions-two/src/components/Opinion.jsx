...
export function Opinion({ opinion: { id, title, body, userName, votes } }) {
  ...
  const [_upvoteFormData, upvoteFormAction, upvotePending] = useActionState(upvoteAction);
  const [_downvoteFormData, downvoteFormAction, downvotePending] = useActionState(downvoteAction);
